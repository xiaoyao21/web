...
function people()
{
	console.log(people_obj)
	 right_[0].innerHTML=people_obj.orderAddress;
...
function food()
{
	...
	for(let i=0;i<food_obj.length;i++)
	{
		...
		<tr>
			<td class="dingdan">
				<div class="iborder">
				<center><img src="${food_obj[i].goods.goodsImg}" width="65px" height="65px" class="viamge"></center>
				</div>
		...
		else if(status_l == '待发货')
		{
			...
			<tr>
				...
				<td class="shuliang">
					x${food_obj[i].detailNum}
				</td><td class="zhuangtai" rowspan="${food_obj.length}">
