...
for(let i =0;i<json2.rows.length;i++){//3
          ...
          <table>`
                ...
                <td class="dingdan">
                    <div class="iborder">
                    <center><img src="${json2.rows[i].orderDetails[0].goods.goodsImg}" width="65px" height="65px" class="viamge"></center>
                    </div>
            ...
            var dingdan = dingdan+`
                ...
                <td class="dingdan">
                    <div class="iborder">
                    <center><img src="${json2.rows[i].orderDetails[j].goods.goodsImg}" width="65px" height="65px" class="viamge"></center>
                    </div>
  ...
  for(var i=0;i<_midle.children.length;i++){
    ...
    for(var j=0;j<batch_change.length;j++){
      if(batch_change[j] == _midle.children[i].children[0].children[3].innerHTML){
          _midle.children[i].children[1].children[0].children[0].children[0].children[3].children[0].children[0].innerHTML = "待收货"
          _midle.children[i].children[1].children[0].children[0].children[0].children[3].children[0].children[1].style.visibility = "hidden"
      }
    } 
    }
	...
	var pac_more=document.getElementsByClassName("pac_more");
		for(let i=0;i<canshu;i++){
		  ...
		  index=this.getAttribute("index");
			window.open("../html/detail.html?index="+index+"&curpage="+curpage);
